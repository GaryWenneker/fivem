...
-- System Infos
PerformHttpRequest(DiscordWebhookSystemInfos, function(Error, Content, Head) end, 'POST', json.encode({username = SystemName, content = '**Just when I thougth I was out.. they pull me back in!**'}), { ['Content-Type'] = 'application/json' })
